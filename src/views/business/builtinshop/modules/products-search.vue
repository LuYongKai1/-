...
const shopTypeOptions = [
  { label: "全部", value: "" },
  { label: "兑换商城", value: "兑换商城" },
  { label: "坐骑兑换", value: "坐骑兑换" },
  { label: "时装兑换", value: "时装兑换" },
  { label: "灵宠召唤", value: "灵宠召唤" },
  { label: "点券商城", value: "点券商城" },
  { label: "礼包商城", value: "礼包商城" },
  { label: "金币商城", value: "金币商城" },
];
