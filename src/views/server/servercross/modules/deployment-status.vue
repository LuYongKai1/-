  ...
  <div class="deployment-status">
    ...
    <div class="overall-status mb-4">
      <div class="flex justify-between items-center">
        <h3 class="text-base font-semibold text-gray-400">{{ $t('page.manage.serveritem.deployment.overallStatus') }}</h3>
    ...
    <div class="services-status mb-4">
      <h3 class="text-base font-semibold text-gray-400 mb-3">{{ $t('page.manage.serveritem.deployment.deploymentStatus') }}</h3>
      <div class="grid grid-cols-3 gap-3">
        <div
          v-for="(service, key) in services"
          :key="key"
          class="service-item flex items-center justify-between p-3 rounded-lg border border-gray-200 hover:shadow-md transition-shadow"
        >
          <div class="flex items-center space-x-2 flex-1 min-w-0">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center space-x-2 mb-1">
                <h4 class="font-medium text-gray-400 text-sm truncate">{{ getServiceName(key) }}</h4>
                <span :class="STATUS_BADGE_CLASSES[service.status]" class="px-2 py-0.5 text-xs rounded-full flex-shrink-0">
    ...
    <div class="deployment-logs">
      ...
      <div class="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm max-h-96 overflow-y-auto" ref="logContainer">
        <!-- 优先显示SSE实时日志 -->
