...
interface Emits {
  (e: "reset"): void;
  (e: "search", channelId: string, groupType: string, targetDay?: string | null, beginTime?: string, endTime?: string,): void;
}
...
watch(
  () => [model.value.channelId, model.value.groupType, model.value.targetDay, model.value.dateRange, ],
  () => {
