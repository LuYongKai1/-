<script setup lang="tsx">
  ...
  import {
    fetchGetRolePayRetentionList,
  } from "@/service/api";
  import { $t } from "@/locales";
  import { useAppStore } from "@/store/modules/app";
  import { serverStatusWhite } from "@/constants/business";
  import { useTable, useTableOperate } from "@/hooks/common/table";
  import RetentionRoleSearch from "./modules/retentionuser-search.vue";
  ...
  const {
    ...
    apiFn: fetchGetRolePayRetentionList,
    showTotal: true,
    immediate: false,
    apiParams: {
      current: 1,
    ...
    columns: () => [
    {
      ...
      {
        key: "serverName",
        title: $t("page.manage.retention.serverName"),
        align: "center",
        minWidth: 130,
      ...
      {
        key: "channelName",
        title: $t("page.manage.retention.channelName"),
        align: "center",
        minWidth: 130,
        ellipsis: { tooltip: true },
        render: (row) => {
