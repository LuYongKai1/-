  ...
  <NCard :bordered="false" size="small" class="card-wrapper" :title="$t('common.search')">
    <NForm :model="model" label-placement="left" :label-width="80" @keyup.enter="search">
      <NGrid responsive="screen" item-responsive>
        <NFormItemGi span="24 s:12 m:6" :label="$t('page.manage.operateserver.auditStatus')" path="audit" class="pr-24px">
          <NSelect
            v-model:value="model.audit"
            :options="auditStatusOptions"
            :placeholder="$t('page.manage.operateserver.form.auditStatus')"
            clearable
          />
        </NFormItemGi>
